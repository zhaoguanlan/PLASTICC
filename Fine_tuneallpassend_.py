...
class fine_tuneBERT(BERT):
    def __init__(self):
        ...
        self.fc2.weight = nn.Parameter(torch.rand(32, 128, requires_grad=True))
        self.fc2.bias = nn.Parameter(torch.rand(32, requires_grad=True))
...
if __name__ == '__main__':
    ...
    optimizer = optim.AdamW(model.parameters(), lr=0.0002)  # AdamW: 论文采用的Adam扩展版本
